...
function ImgUpload() {
  ...
  return (
    <div className='flex items-center h-14 w-4/5 sm:w-5/6 border-2 border-slate-300 rounded-lg'>
      <input type="file" id="image-input" hidden onChange={(e)=>imageHandler(e)} />
      <FontAwesomeIcon icon={faImage} className="text-blue-600 m-2 cursor-pointer"/>
      <label className='text-sm text-slate-400' >Change the ad creative image.</label>
