...
function CustomAddContent() {
  ...
  return (
    <div className='flex flex-col border-2 border-slate-300 sm:w-5/6 sm:h-14 w-5/6 h-13 rounded-lg  '>
      <label className=' mx-3 mt-1 mb-1 text-slate-300 text-xs font-bold'>Ad Content</label>
